# Neo-Brutalism Research Sources
...
- **Type:** Book / Academic Text
- **Description:** Seminal architectural history text that defined and analyzed the New Brutalism movement. Essential reading for understanding the philosophical foundations.
- **Key Concepts:** Material honesty, béton brut, Brutalist ethics vs. aesthetics
- **Relevance:** Provides historical context for the principles we adapt to digital design

### 2. **Alison and Peter Smithson - Architectural Writings**
- **Type:** Architects / Primary Sources
- **Description:** The Smithsons coined the term "New Brutalism" and designed key works like Hunstanton School (1954). Their writings articulate the movement's core values.
- **Key Works:** Hunstanton School, Robin Hood Gardens
- **Relevance:** Direct source of brutalist design philosophy

### 3. **Le Corbusier - Unité d'Habitation (1952)**
- **Type:** Building / Case Study
- **Location:** Marseille, France
- **Description:** Iconic example of béton brut (raw concrete). Massive residential block showing modular design, exposed materials, and functionalist approach.
- **Key Features:** Pilotis, modular apartments, roof terrace, rough concrete finish
...
- **Relevance:** Visual reference library showing range of brutalist architecture
...
- **Relevance:** Demonstrates that brutalist principles support usability and performance

### 9. **The Outline (2016-2020)**
- **Type:** Case Study / Digital Publication
- **Description:** News site with bold, boundary-pushing design. Heavy borders, unexpected layouts, system fonts.
...
- **Relevance:** Technical reference for implementing brutalist typography
...
- **Relevance:** Living community discussing contemporary applications
...
- Start with Banham (#1) and the Smithsons (#2)
- Study Le Corbusier's Unité (#3) for visual language
- Browse SOS Brutalism (#4) for architectural variety

### For Digital Inspiration
- Explore Brutalist Websites (#5) for dozens of examples
- Analyze Bloomberg (#6), Balenciaga (#7), The Outline (#9) for production techniques
- Study accidental brutalism (Hacker News #8, Craigslist #10) for functional purity

### For Practical Implementation
- Read design commentary (#11-13) for context and strategy
- Study accessibility article (#14) before designing
- Use Typewolf (#15) and CSS-Tricks (#17) for technical details
- Reference Copeland's manifesto (#19) for ethical guidelines

### For Ongoing Research
- Follow Dribbble (#16) and Behance (#18) for new work
- Join Reddit (#20) for community discussion
- Check Awwwards (#12) for award-winning examples

---

## Research Notes

- Neo-brutalism is not a rigid style but a set of principles: honesty, function, structure
...
If you want to dive deeper, explore:
- **Anti-design movements:** Swiss/International Style, punk aesthetics, zine culture
- **Related web movements:** Web 1.0 nostalgia, Y2K aesthetic revival, maximalism
- **Accessibility research:** WCAG guidelines, inclusive design principles
- **Performance optimization:** Static site generators, minimal JS, progressive enhancement
